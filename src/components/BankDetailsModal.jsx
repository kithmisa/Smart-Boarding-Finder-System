        ...
        <div className="p-6 space-y-6">
          ...
          <div>
            <label className="flex items-center text-sm font-medium text-gray-700 mb-2">
              <UserCheck className="mr-2 w-4 h-4 text-yellow-600" />
              Account Holder Name *
            </label>
            <input
              type="text"
              ...
              className={`w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors ${
                errors.accountHolderName ? 'border-red-500 bg-red-50' : 'border-yellow-600'
              }`}
            />
          ...
          <div>
            ...
            <select
              ...
              onChange={handleChange}
              className={`w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors ${
                errors.accountType ? 'border-red-500 bg-red-50' : 'border-yellow-600'
              }`}
            >
          ...
          <div>
            <label className="flex items-center text-sm font-medium text-gray-700 mb-2">
              <Building2 className="mr-2 w-4 h-4 text-yellow-600" />
              Bank Name *
            </label>
            <select
              name="bankName"
              ...
              onChange={handleChange}
              className={`w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-yellow-500 focus:border-blue-500 transition-colors ${
                errors.bankName ? 'border-red-500 bg-red-50' : 'border-yellow-600'
              }`}
            >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              <label className="flex items-center text-sm font-medium text-gray-700 mb-2">
                <MapPin className="mr-2 w-4 h-4 text-yellow-600" />
                Branch Name *
              </label>
              <input
                type="text"
                ...
                className={`w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors ${
                  errors.branchName ? 'border-red-500 bg-red-50' : 'border-yellow-600'
                }`}
              />
              {errors.branchName && (
            ...
            <div>
              <label className="flex items-center text-sm font-medium text-gray-700 mb-2">
                <Hash className="mr-2 w-4 h-4 text-yellow-600" />
          ...
          <div className="flex space-x-4 pt-6 border-t">
            ...
            <button
              ...
              disabled={loading}
              className="flex-1 px-6 py-3 bg-gradient-to-r from-pink-600 to-purple-600 text-white rounded-lg hover:from-blue-700 hover:to-purple-700 transition-colors font-medium disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {loading ? (
